...
constexpr DWORD kInjectedFlag = 0x10;

bool is_key_down(UINT msg_type) {
    return msg_type == kWmKeyDown || msg_type == kWmSysKeyDown;
}

bool is_key_up(UINT msg_type) {
    return msg_type == kWmKeyUp || msg_type == kWmSysKeyUp;
}
